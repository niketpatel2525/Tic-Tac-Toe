...
public interface fd extends IInterface {
    ...
    public static abstract class C0445a extends Binder implements fd {

        /* renamed from: com.google.android.gms.internal.fd.a.a */
        private static class C0444a implements fd {
            private IBinder dG;
            ...
            public void m1475a(int i, Bundle bundle, int i2, Intent intent) throws RemoteException {
        ...
        public static fd ak(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof fd)) ? new C0444a(iBinder) : (fd) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case DetectedActivity.ON_BICYCLE /*1*/:
                    ...
                    m585a(data.readInt(), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, data.readInt(), data.readInt() != 0 ? (Intent) Intent.CREATOR.createFromParcel(data) : null);
    ...
    void m585a(int i, Bundle bundle, int i2, Intent intent) throws RemoteException;
}
