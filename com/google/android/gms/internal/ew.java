...
public interface ew extends IInterface {
    ...
    public static abstract class C0438a extends Binder implements ew {

        /* renamed from: com.google.android.gms.internal.ew.a.a */
        private static class C0437a implements ew {
            private IBinder dG;
        ...
        public static ew m1455E(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.location.internal.IGeofencerCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ew)) ? new C0437a(iBinder) : (ew) queryLocalInterface;
        }
