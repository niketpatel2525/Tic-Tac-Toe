...
public interface fj extends IInterface {
    ...
    public static abstract class C0455a extends Binder implements fj {

        /* renamed from: com.google.android.gms.internal.fj.a.a */
        private static class C0454a implements fj {
            private IBinder dG;
        ...
        public static fj ap(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof fj)) ? new C0454a(iBinder) : (fj) queryLocalInterface;
        }
