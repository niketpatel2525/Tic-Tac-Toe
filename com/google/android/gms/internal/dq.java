...
public class dq<K, V> {
    ...
    public final V get(K key) {
        ...
        synchronized (this) {
            ...
            synchronized (this) {
                this.lp++;
                v = this.lm.put(key, create);
                if (v != null) {
                    this.lm.put(key, v);
                } else {
                    this.size += m403b(key, create);
                }
            }
            if (v != null) {
    ...
    public final V put(K key, V value) {
        ...
        synchronized (this) {
            this.lo++;
            this.size += m403b(key, value);
            put = this.lm.put(key, value);
            if (put != null) {
                this.size -= m403b(key, put);
            }
        }
        if (put != null) {
    ...
    public final synchronized String toString() {
        ...
        int i = 0;
        synchronized (this) {
            int i2 = this.lr + this.ls;
            if (i2 != 0) {
                i = (this.lr * 100) / i2;
            }
            format = String.format("LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.ln), Integer.valueOf(this.lr), Integer.valueOf(this.ls), Integer.valueOf(i)});
        }
        return format;
    }
    ...
    L_0x0043:
        ...
        r2 = r4.lm;	 Catch:{ all -> 0x0032 }
        r2.remove(r1);	 Catch:{ all -> 0x0032 }
        r2 = r4.size;	 Catch:{ all -> 0x0032 }
        r3 = r4.m403b(r1, r0);	 Catch:{ all -> 0x0032 }
        r2 = r2 - r3;
        r4.size = r2;	 Catch:{ all -> 0x0032 }
        r2 = r4.lq;	 Catch:{ all -> 0x0032 }
        r2 = r2 + 1;
        r4.lq = r2;	 Catch:{ all -> 0x0032 }
        monitor-exit(r4);	 Catch:{ all -> 0x0032 }
        r2 = 1;
        r3 = 0;
