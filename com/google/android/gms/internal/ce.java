...
public final class ce {
    ...
    public ce(C0469v c0469v, cq cqVar, List<String> list, int i, List<String> list2, List<String> list3, int i2, long j, String str, boolean z, ao aoVar, ax axVar, String str2, ap apVar, ar arVar, long j2, long j3) {
        this.gB = c0469v;
        this.fU = cqVar;
