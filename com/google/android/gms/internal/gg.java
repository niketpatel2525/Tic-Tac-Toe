...
import com.google.android.gms.internal.fv.C0149e;
...
public final class gg extends C0055b implements Person {
    public gg(C0345d c0345d, int i) {
        super(c0345d, i);
    }
    ...
    public Person ea() {
        return new fv(getDisplayName(), getId(), (C0596c) getImage(), getObjectType(), getUrl());
    }
    ...
    public Image getImage() {
        return new C0596c(getString("image"));
    }
    ...
    public int getObjectType() {
        return C0149e.aa(getString("objectType"));
    }
