...
public final class GooglePlayServicesUtil {
    ...
    public static Dialog m24a(int i, Activity activity, int i2, OnCancelListener onCancelListener, int i3) {
        Builder message = new Builder(activity).setMessage(m30b(activity, i, i3));
        if (onCancelListener != null) {
            message.setOnCancelListener(onCancelListener);
        }
        OnClickListener dcVar = new dc(activity, m25a(activity, i, i3), i2);
        CharSequence b = m29b(activity, i);
        if (b != null) {
        ...
        switch (i) {
            ...
            case DetectedActivity.ON_BICYCLE /*1*/:
                return message.setTitle(C0049R.string.common_google_play_services_install_title).create();
            case DetectedActivity.ON_FOOT /*2*/:
                return message.setTitle(C0049R.string.common_google_play_services_update_title).create();
            case DetectedActivity.STILL /*3*/:
                return message.setTitle(C0049R.string.common_google_play_services_enable_title).create();
            case DetectedActivity.UNKNOWN /*4*/:
            case GamesClient.STATUS_NETWORK_ERROR_OPERATION_FAILED /*6*/:
                return message.setTitle(C0049R.string.common_google_play_services_unknown_issue).create();
            case DetectedActivity.TILTING /*5*/:
                Log.e("GooglePlayServicesUtil", "An invalid account was specified when connecting. Please provide a valid account.");
                return message.setTitle(C0049R.string.common_google_play_services_invalid_account_title).create();
            case GamesClient.STATUS_LICENSE_CHECK_FAILED /*7*/:
                Log.e("GooglePlayServicesUtil", "Network error occurred. Please retry request later.");
                return message.setTitle(C0049R.string.common_google_play_services_network_error_title).create();
            case GamesClient.STATUS_APP_MISCONFIGURED /*8*/:
                Log.e("GooglePlayServicesUtil", "Internal error occurred. Please see logs for detailed information");
                return message.setTitle(C0049R.string.common_google_play_services_unknown_issue).create();
            case ConnectionResult.SERVICE_INVALID /*9*/:
                Log.e("GooglePlayServicesUtil", "Google Play services is invalid. Cannot recover.");
                return message.setTitle(C0049R.string.common_google_play_services_unsupported_title).create();
    ...
    public static Intent m25a(Context context, int i, int i2) {
        switch (i) {
            case DetectedActivity.ON_BICYCLE /*1*/:
            case DetectedActivity.ON_FOOT /*2*/:
                return m34n(i2) ? m36o(context) ? dg.m361C(GOOGLE_PLAY_SERVICES_PACKAGE) : dg.m360B("com.google.android.apps.bazaar") : dg.m360B(GOOGLE_PLAY_SERVICES_PACKAGE);
            case DetectedActivity.STILL /*3*/:
                return dg.m362z(GOOGLE_PLAY_SERVICES_PACKAGE);
            case ConnectionResult.DATE_INVALID /*12*/:
                return dg.bj();
            default:
                return null;
    ...
    public static boolean m26a(Resources resources) {
        return (ek.bJ() && ((resources.getConfiguration().screenLayout & 15) > 3)) || m31b(resources);
    }

    private static byte[] m27a(PackageInfo packageInfo, byte[]... bArr) {
        try {
    ...
    private static byte[][] m28a(byte[][]... bArr) {
        int i = 0;
    ...
    public static boolean aI() {
        return iX ? iY : C0301h.MODEL_USER.equals(Build.TYPE);
    }

    public static String m29b(Context context, int i) {
        Resources resources = context.getResources();
        switch (i) {
            case DetectedActivity.ON_BICYCLE /*1*/:
                return resources.getString(C0049R.string.common_google_play_services_install_button);
            case DetectedActivity.ON_FOOT /*2*/:
                return resources.getString(C0049R.string.common_google_play_services_update_button);
            case DetectedActivity.STILL /*3*/:
                return resources.getString(C0049R.string.common_google_play_services_enable_button);
            default:
                return resources.getString(17039370);
        }
    }

    public static String m30b(Context context, int i, int i2) {
        Resources resources = context.getResources();
        String string;
        switch (i) {
            case DetectedActivity.ON_BICYCLE /*1*/:
                string = m26a(context.getResources()) ? resources.getString(C0049R.string.common_google_play_services_install_text_tablet) : resources.getString(C0049R.string.common_google_play_services_install_text_phone);
                return m34n(i2) ? string + " (via Bazaar)" : string;
            case DetectedActivity.ON_FOOT /*2*/:
                string = resources.getString(C0049R.string.common_google_play_services_update_text);
                return m34n(i2) ? string + " (via Bazaar)" : string;
            case DetectedActivity.STILL /*3*/:
                return resources.getString(C0049R.string.common_google_play_services_enable_text);
            case DetectedActivity.TILTING /*5*/:
                return resources.getString(C0049R.string.common_google_play_services_invalid_account_text);
            case GamesClient.STATUS_LICENSE_CHECK_FAILED /*7*/:
                return resources.getString(C0049R.string.common_google_play_services_network_error_text);
            case ConnectionResult.SERVICE_INVALID /*9*/:
                return resources.getString(C0049R.string.common_google_play_services_unsupported_text);
            case ConnectionResult.DATE_INVALID /*12*/:
                return resources.getString(C0049R.string.common_google_play_services_unsupported_date_text);
            default:
                return resources.getString(C0049R.string.common_google_play_services_unknown_issue);
        }
    }

    private static boolean m31b(Resources resources) {
        Configuration configuration = resources.getConfiguration();
        return ek.bL() && (configuration.screenLayout & 15) <= 3 && configuration.smallestScreenWidthDp >= 600;
    }

    public static Dialog getErrorDialog(int errorCode, Activity activity, int requestCode) {
        return m24a(errorCode, activity, requestCode, null, -1);
    }

    public static Dialog getErrorDialog(int errorCode, Activity activity, int requestCode, OnCancelListener cancelListener) {
        return m24a(errorCode, activity, requestCode, cancelListener, -1);
    }

    public static PendingIntent getErrorPendingIntent(int errorCode, Context context, int requestCode) {
        Intent a = m25a(context, errorCode, -1);
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0049R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
        ...
        m33n(context);
        try {
            if (m27a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 64), iQ) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                return 9;
            }
            try {
                PackageInfo packageInfo = packageManager.getPackageInfo(GOOGLE_PLAY_SERVICES_PACKAGE, 64);
                if (m27a(packageInfo, r4) == null) {
    ...
    public static void m32m(Context context) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        int isGooglePlayServicesAvailable = isGooglePlayServicesAvailable(context);
        if (isGooglePlayServicesAvailable != 0) {
            Intent a = m25a(context, isGooglePlayServicesAvailable, -1);
    ...
    private static void m33n(Context context) {
    ...
    private static int m35o(int i) {
        return i == -1 ? 2 : i;
    }

    private static boolean m36o(Context context) {
        if (iX) {
            return iZ;
        }
        try {
            return m27a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), iW) != null;
        } catch (NameNotFoundException e) {
            return false;
        }
    }

    private static byte[] m37t(String str) {
        try {
