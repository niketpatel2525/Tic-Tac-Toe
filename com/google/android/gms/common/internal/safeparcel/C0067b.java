...
public class C0067b {
    ...
    public static void m117a(Parcel parcel, int i, Bundle bundle, boolean z) {
        if (bundle != null) {
            int A = C0067b.m110A(parcel, i);
            parcel.writeBundle(bundle);
            C0067b.m111B(parcel, A);
        } else if (z) {
            C0067b.m129b(parcel, i, 0);
        }
    }
        ...
        if (tArr != null) {
            ...
            for (Parcelable parcelable : tArr) {
                if (parcelable == null) {
                    ...
                    C0067b.m128a(parcel, parcelable, i2);
                }
            }
            C0067b.m111B(parcel, A);
        } else if (z) {
        ...
        if (list != null) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (parcelable == null) {
                    ...
                    C0067b.m128a(parcel, parcelable, 0);
                }
            }
            C0067b.m111B(parcel, A);
        } else if (z) {
    ...
    public static int m133k(Parcel parcel) {
        return C0067b.m110A(parcel, 20293);
    }
}
