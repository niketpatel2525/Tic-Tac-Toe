...
import com.google.android.gms.maps.internal.C0175g.C0505a;

public interface ILocationSourceDelegate extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.ILocationSourceDelegate.a */
    public static abstract class C0485a extends Binder implements ILocationSourceDelegate {

        /* renamed from: com.google.android.gms.maps.internal.ILocationSourceDelegate.a.a */
        private static class C0484a implements ILocationSourceDelegate {
            private IBinder dG;
            ...
            public void activate(C0175g listener) throws RemoteException {
        ...
        public static ILocationSourceDelegate m1542M(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ILocationSourceDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ILocationSourceDelegate)) ? new C0484a(iBinder) : (ILocationSourceDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case DetectedActivity.ON_BICYCLE /*1*/:
                    ...
                    activate(C0505a.m1559R(data.readStrongBinder()));
    ...
    void activate(C0175g c0175g) throws RemoteException;
