...
public interface IProjectionDelegate extends IInterface {
    ...
    public static abstract class C0491a extends Binder implements IProjectionDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IProjectionDelegate.a.a */
        private static class C0490a implements IProjectionDelegate {
            private IBinder dG;
            ...
            public LatLng fromScreenLocation(C0071b point) throws RemoteException {
                LatLng latLng = null;
            ...
            public C0071b toScreenLocation(LatLng location) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IProjectionDelegate");
        ...
        public static IProjectionDelegate m1545Z(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IProjectionDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IProjectionDelegate)) ? new C0490a(iBinder) : (IProjectionDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case DetectedActivity.ON_BICYCLE /*1*/:
                    ...
                    LatLng fromScreenLocation = fromScreenLocation(C0354a.m1114z(data.readStrongBinder()));
                ...
                case DetectedActivity.ON_FOOT /*2*/:
                    data.enforceInterface("com.google.android.gms.maps.internal.IProjectionDelegate");
                    C0071b toScreenLocation = toScreenLocation(data.readInt() != 0 ? LatLng.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
    ...
    LatLng fromScreenLocation(C0071b c0071b) throws RemoteException;

    VisibleRegion getVisibleRegion() throws RemoteException;

    C0071b toScreenLocation(LatLng latLng) throws RemoteException;
}
