...
public interface C0201f extends IInterface {

    /* renamed from: com.google.android.gms.maps.model.internal.f.a */
    public static abstract class C0536a extends Binder implements C0201f {

        /* renamed from: com.google.android.gms.maps.model.internal.f.a.a */
        private static class C0535a implements C0201f {
            private IBinder dG;
            ...
            public boolean m1595a(C0201f c0201f) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    obtain.writeStrongBinder(c0201f != null ? c0201f.asBinder() : null);
        ...
        public static C0201f ai(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0201f)) ? new C0535a(iBinder) : (C0201f) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case GamesClient.STATUS_APP_MISCONFIGURED /*8*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    isVisible = m766a(C0536a.ai(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
    ...
    boolean m766a(C0201f c0201f) throws RemoteException;
