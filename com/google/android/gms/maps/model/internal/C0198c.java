...
public interface C0198c extends IInterface {

    /* renamed from: com.google.android.gms.maps.model.internal.c.a */
    public static abstract class C0530a extends Binder implements C0198c {

        /* renamed from: com.google.android.gms.maps.model.internal.c.a.a */
        private static class C0529a implements C0198c {
            private IBinder dG;
            ...
            public boolean m1590a(C0198c c0198c) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    obtain.writeStrongBinder(c0198c != null ? c0198c.asBinder() : null);
            ...
            public void m1591h(C0071b c0071b) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
        ...
        public static C0198c ae(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0198c)) ? new C0529a(iBinder) : (C0198c) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TimeUtils.HUNDRED_DAY_FIELD_LEN /*19*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    isVisible = m761a(C0530a.ae(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
                ...
                case 21:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    m762h(C0354a.m1114z(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    boolean m761a(C0198c c0198c) throws RemoteException;
    ...
    void m762h(C0071b c0071b) throws RemoteException;
