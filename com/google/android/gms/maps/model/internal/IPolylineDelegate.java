...
public interface IPolylineDelegate extends IInterface {
    ...
    public static abstract class C0524a extends Binder implements IPolylineDelegate {

        /* renamed from: com.google.android.gms.maps.model.internal.IPolylineDelegate.a.a */
        private static class C0523a implements IPolylineDelegate {
            private IBinder dG;
        ...
        public static IPolylineDelegate ah(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IPolylineDelegate)) ? new C0523a(iBinder) : (IPolylineDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case ViewDragHelper.EDGE_ALL /*15*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    isVisible = equalsRemote(C0524a.ah(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
