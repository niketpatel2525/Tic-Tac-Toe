...
public final class AdSize {
    ...
    private final com.google.android.gms.ads.AdSize f3c;
    ...
    static {
        ...
        IAB_BANNER = new AdSize(IM.INLINE_WIDTH, 60, "as");
    ...
    public boolean equals(Object other) {
        ...
        return this.f3c.equals(((AdSize) other).f3c);
    }
    ...
    public int getHeightInPixels(Context context) {
        return this.f3c.getHeightInPixels(context);
    }
    ...
    public int getWidthInPixels(Context context) {
        return this.f3c.getWidthInPixels(context);
    }
