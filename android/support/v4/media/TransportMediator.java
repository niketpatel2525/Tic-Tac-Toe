...
public class TransportMediator extends TransportController {
    ...
    class C00112 implements Callback {
        C00112() {
        }
    ...
    class C03301 implements TransportMediatorCallback {
        C03301() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C03301();
        this.mKeyEventCallback = new C00112();
    ...
    private void reportPlayingChanged() {
        ...
        if (listeners != null) {
            ...
            int len$ = arr$.length;
            for (int i$ = 0; i$ < len$; i$ += FLAG_KEY_MEDIA_PREVIOUS) {
