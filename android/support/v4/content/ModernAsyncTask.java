...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C00081 implements ThreadFactory {
    ...
    class C00093 extends FutureTask<Result> {
        C00093(Callable x0) {
            super(x0);
        }
    ...
    class C03292 extends WorkerRunnable<Params, Result> {
        C03292() {
            super();
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C03292();
        this.mFuture = new C00093(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00104.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
