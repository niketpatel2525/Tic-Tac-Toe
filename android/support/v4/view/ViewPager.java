...
public class ViewPager extends ViewGroup {
    ...
    static class C00281 implements Comparator<ItemInfo> {
        C00281() {
        }
    ...
    static class C00292 implements Interpolator {
        C00292() {
        }
    ...
    class C00303 implements Runnable {
        C00303() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C03351 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03351() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C03351());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00281();
        sInterpolator = new C00292();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00303();
